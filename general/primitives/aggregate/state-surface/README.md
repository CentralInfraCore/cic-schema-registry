...
The read-only observed-state surface of a ManagedEntity. Populated by the adapter — shows what is actually present in the system.
...
`primitives/@v0.2.0` release**-ből — az eredeti fájl (schemas/aggregate/state-surface.yaml)
...
fájlhoz tartozó `meta_hash`: `qY9QsW16+lnIrdf4eymj25B0FQrtxeBPWhdgZAZ7wZI=`.
